...
export function MyBorrowingsContent({ borrows }: MyBorrowingsContentProps) {
  return (
    <>
      <PageIntro
        className="mb-12"
          ...
          <article key={borrow.id} className="group flex flex-col overflow-hidden rounded-xl bg-white md:flex-row">
            ...
            <div className="flex flex-1 flex-col justify-between gap-6 p-8">
              ...
              <div className="flex gap-3">
                <button className="rounded-full bg-indigo-100 px-6 py-2.5 text-xs font-bold text-indigo-900">
                  Extend
                </button>
