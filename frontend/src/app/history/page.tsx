        ...
        <table className="w-full border-collapse text-left">
          <thead>
            <tr className="border-b bg-slate-100">
              ...
              <th className="px-6 py-5 text-xs font-bold tracking-widest text-slate-500 uppercase">Borrowed</th>
              <th className="px-6 py-5 text-xs font-bold tracking-widest text-slate-500 uppercase">Returned</th>
              <th className="px-6 py-5 text-xs font-bold tracking-widest text-slate-500 uppercase">Savings</th>
              <th className="px-8 py-5 text-right text-xs font-bold tracking-widest text-slate-500 uppercase">Status</th>
            </tr>
          </thead>
          <tbody>
            {history.map((item) => (
